...
- Section 6 real data example, Experiment 2 (Figure 9)- file ***Metric Skewness for Experiment Design (Mac).R*** in the folder [Experiment Design](https://github.com/vidazamani/Metric-Skewness-for-Object-Data/tree/V4/Experiment%20Design) 
