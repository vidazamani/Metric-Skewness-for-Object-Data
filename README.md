...
- Section 6 real data example, Experiment 1 (Figure 8) - files in the folder [Other Optimizations](https://github.com/vidazamani/Depth-functions-for-Object-Data/tree/main/Other%20Optimizations).
- Section 6 real data example, Experiment 2 (Figure 9)- file ***Metric Skewness for Experiment Design (Mac).R*** in subfolder [Metric Skewness for Experiment Design](https://github.com/vidazamani/Depth-functions-for-Object-Data/tree/main/Real%20data%20examples/Depth%20Based%20Rank%20Test) 
